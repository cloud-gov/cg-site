...
If you're running the `python manage.py` commands from the server, you might have to do:
...
An easy way to check this is to `cf ssh [APPNAME]` and run python -c "import django" 