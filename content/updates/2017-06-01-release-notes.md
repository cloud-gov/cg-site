...
- We improved monitoring and reliability for the [Redis]({{< relref "docs/services/redis.md" >}}) and [Elasticsearch]({{< relref "docs/services/elasticsearch24.md" >}}) services, enabling them to automatically restart if non-responsive.
