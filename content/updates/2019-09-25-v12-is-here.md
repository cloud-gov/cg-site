...
This month, there was a major release of the cf-deployment: v12.0.0. We've integrated it into our deployment, applied our normal changes to it, tested it, and deployed it. As of this writing, v12.0.0 is deployed and available to customers. While many changes highlighted are aimed at improving availability, there are 48 CVEs (Common Vulnerabilities and Exposures) patched, so this update is worth talking about.

You'll find a human-friendly description of each major change and how it's relevant to major components of the system below.
