...
Here's the latest on how we've been trying to make cloud.gov simpler and more secure. (If you find yourself needing to explain cloud.gov to coworkers or leadership, take a look at our [new two-pager](/assets/files/cloudgov-overview-2018.pdf)!)
...
* We have a new [S3 plan for sandboxes]({{< relref "/updates/2018-10-22-s3-sandbox-plan.md" >}}) that automatically clears your S3 contents whenever your sandbox is cleared
* We offer a [custom domain service]({{< relref "/updates/2018-05-21-new-custom-domain-service.md" >}}) that doesn't use CloudFront, since CloudFront is currently outside the AWS FedRAMP P-ATO boundary
