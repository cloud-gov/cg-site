...
The preferred way to invite new users is to [invite them](https://invite.cloud.gov). If you need to create a user manually, follow the instructions for [the `provision-user-space` CLI plugin](https://github.com/18F/cf-provision-user-space-plugin).
