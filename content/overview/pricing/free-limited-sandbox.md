...
* You can only create certain managed service instances. (See each [service documentation page]({{< relref "docs/services/index.md" >}}) for details about which service instances are available in sandboxes.)
