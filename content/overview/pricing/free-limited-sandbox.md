...
Anyone with a U.S. federal government email address can [request a free sandbox space](https://account.fr.cloud.gov/signup). No paperwork is required from us. (It's up to you to determine whether you may need permission from your organization.) If you have other questions or comments, see [Contact]({{< relref "docs/help.md" >}}).
