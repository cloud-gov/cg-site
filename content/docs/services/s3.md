...
From developer system, set the AWS environment variables and put the object in the bucket 
...
Bind the S3 bucket service to an `example-app` which has `aws` CLI installed:
