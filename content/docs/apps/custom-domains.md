...
To make your app accessible via your custom domain name, use the [CDN service]({{< relref "docs/services/cdn-route.md" >}}) or the [custom domain service]({{< relref "docs/services/custom-domains.md" >}}). Those pages provide instructions for the DNS entries you need to create in your DNS system.
