...
{{< image title="App Overview dashboard" src="img/app-overview.png" >}}
...
{{< image title="Time period selection" src="img/time-period.png" >}}
...
{{< image title="Select dashboards" src="img/select-dashboard.png" >}}
