...
- Elasticsearch 2.4 is available.
    - If you're using 1.7, it's recommended that you upgrade, since 1.7 hit [end of life](https://www.elastic.co/support/eol) on January 6, 2017. [Read about the breaking changes.](https://www.elastic.co/guide/en/elasticsearch/reference/2.0/breaking-changes-2.0.html)
