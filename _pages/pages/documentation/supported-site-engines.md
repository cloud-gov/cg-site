...
For more details on using Node see [node on federalist]({{site.baseurl}}/pages/documentation/node-on-federalist).
...
For an example of a Jekyll site optimized for Federalist, see our [templates]({{site.baseurl}}/pages/documentation/templates/).
