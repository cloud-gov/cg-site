...
For details, see SC-28 in the cloud.gov System Security Plan in our [P-ATO documentation package]({{ site.baseurl }}/docs/security/fedramp-tracker/#how-you-can-use-this-p-ato).
