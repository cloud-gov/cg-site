...
* You can only create certain managed service instances. (See each [service documentation page]({{ site.baseurl }}{% link _docs/services/_intro.md %}) for details about which service instances are available in sandboxes.)
