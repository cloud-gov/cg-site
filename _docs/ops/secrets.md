...
Details on using `aws-vault` on our team are in our [internal documentation](https://github.com/cloud-gov/aws-admin/blob/main/docs/user_access.md#initial-setup).
