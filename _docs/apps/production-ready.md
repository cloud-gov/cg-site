...
#### How
* See [multiple instances]({{ site.baseurl }}{% link _docs/apps/multiple-instances.md %}).
...
* Protect access to platform provided variables such as `VCAP_SERVICES` for [managed services]({{ site.baseurl }}{% link _docs/apps/managed-services.md %}) and `DATABASE_URL` for [the database service]({{ site.baseurl }}{% link _docs/services/relational-database.md %}).
...
#### How
* See [continuous deployment]({{ site.baseurl }}{% link _docs/apps/continuous-deployment.md %}).
...
#### How
* See [custom domains]({{ site.baseurl }}{% link _docs/apps/custom-domains.md %}).
