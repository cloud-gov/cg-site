...
* The default amount of memory for staging applications has been increased from 1GB to 2GB to attempt to mitigate staging OOM issues.   Once we verify the recently deployed stemcells with the fix, we will be dropping it back down to 1 GB. 
...
- We recently deployed v1.406 of the Jammy Stemcell as part of CF-Deployment v39.7.0.
...
Note that v39.7.0 was mainly an update from v1.404 to v1.406 of the Jammy Stemcell, the rest listed below are for v39.6.0.
...
- Add libunwind 1.8.1, remove libunwind 1.8.0 for stack(s) cflinuxfs3, cflinuxfs4 ([#925](https://github.com/cloudfoundry/dotnet-core-buildpack/pull/925))
...
| -------------------------------- | ---------------- | ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| AppDynamics Agent                | `24.2.0_35552`   |                                                                                    | [Release Notes](https://docs.appdynamics.com/4.5.x/en/product-and-release-announcements/release-notes/language-agent-notes/java-agent-notes) |
...
| PostgreSQL JDBC Driver           | `42.7.2`         |                                                                                    | [ChangeLog](https://jdbc.postgresql.org/documentation/changelog.html)                                                                        |
...
- Add nginx 1.25.4, remove nginx 1.25.3 ([#267](https://github.com/cloudfoundry/nginx-buildpack/pull/267))  
    for stack(s) cflinuxfs4, cflinuxfs3  
    ([https://www.pivotaltracker.com/story/show/187047474](https://www.pivotaltracker.com/story/show/187047474))
...
- Add jruby 9.4.6.0, remove jruby 9.4.5.0 ([#906](https://github.com/cloudfoundry/ruby-buildpack/pull/906))  
    ...
    ([https://www.pivotaltracker.com/story/show/187082819](https://www.pivotaltracker.com/story/show/187082819))
    
- Add node 20.11.1, remove node 20.11.0 ([#905](https://github.com/cloudfoundry/ruby-buildpack/pull/905))  
    for stack(s) cflinuxfs3, cflinuxfs4  
    ([https://www.pivotaltracker.com/story/show/187048168](https://www.pivotaltracker.com/story/show/187048168))
...
- Add nginx 1.25.4, remove nginx 1.25.3 ([#408](https://github.com/cloudfoundry/staticfile-buildpack/pull/408))  
    for stack(s) cflinuxfs4, cflinuxfs3  
    ([https://www.pivotaltracker.com/story/show/187047410](https://www.pivotaltracker.com/story/show/187047410))

### CFLinuxfs4 - v1.75.0 up from v1.73.0 

Notably, this release addresses:
[USN-6694-1](https://ubuntu.com/security/notices/USN-6694-1) Expat vulnerabilities:

- [CVE-2024-28757](https://ubuntu.com/security/CVE-2024-28757):  
...
- [CVE-2023-52425](https://ubuntu.com/security/CVE-2023-52425):  
...
- [CVE-2023-49468](https://ubuntu.com/security/CVE-2023-49468):  
...
- [CVE-2023-49465](https://ubuntu.com/security/CVE-2023-49465):  
    Libde265 v1.0.14 was discovered to contain a heap-buffer-overflow  
    vulnerability in the derive_spatial_luma_vector_prediction function at  
    motion.cc.
- [CVE-2023-27102](https://ubuntu.com/security/CVE-2023-27102):  
    Libde265 v1.0.11 was discovered to contain a segmentation violation via the  
    function decoder_context::process_slice_segment_header at decctx.cc.
- [CVE-2023-49467](https://ubuntu.com/security/CVE-2023-49467):  
    Libde265 v1.0.14 was discovered to contain a heap-buffer-overflow  
    vulnerability in the derive_combined_bipredictive_merging_candidates  
    function at motion.cc.
- [CVE-2023-27103](https://ubuntu.com/security/CVE-2023-27103):  
    Libde265 v1.0.11 was discovered to contain a heap buffer overflow via the  
    function derive_collocated_motion_vectors at motion.cc.
- [CVE-2023-47471](https://ubuntu.com/security/CVE-2023-47471):  
...
- [CVE-2023-43887](https://ubuntu.com/security/CVE-2023-43887):  
    Libde265 v1.0.12 was discovered to contain multiple buffer overflows via  
    the num_tile_columns and num_tile_row parameters in the function  
...
**Full Changelog**: [v77.1.0...v77.2.0](https://github.com/cloudfoundry/uaa-release/compare/v77.1.0...v77.2.0)
